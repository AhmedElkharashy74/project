...
<section class="bg-white" >
  <div class="container-fluid justify-content-center" >
    <div class="row login-card" style="margin: auto; margin-top: 7%;">
    <div class="col-sm-6 px-0 d-none d-sm-block d-flex align-items-center justify-content-center">
        <div class="">
          <form class="login-form" method="POST">
            ...
            <div class="form-outline mb-4">
              <input type="text" id="form2Example18" class="form-control form-control-lg" name="grade"/>
              <label class="form-label" for="form2Example18">grade</label>
            </div>
            <div class="form-outline mb-4">
              <input type="number" id="form2Example18" class="form-control form-control-lg" name="section"/>
              <label class="form-label" for="form2Example18">section</label>
            </div>
